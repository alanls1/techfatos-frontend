  ...
  return (
    <div>
      <div className="max-w-screen-md mx-auto mt-32">
        <div>
          <h2 className="text-4xl mb-9">Política Privacidade</h2>
          <p>
            {" "}
            A sua privacidade é importante para nós. É política do Techfatos
            respeitar a sua privacidade em relação a qualquer informação sua que
            possamos coletar no site Techfatos, e outros sites que possuímos e
            operamos.
            <br />
            <br />
            ...
            dos conteúdos e da informação que o Techfatos oferece no site e com
            caráter enunciativo, mas não limitativo:
          </p>
          <ul className="ps-8 my-8">
            <li>
            ...
            <li>
              ...
              (softwares) do Techfatos, de seus fornecedores ou terceiros, para
        ...
        <div className="mt-32">
          <h3 className="text-4xl mb-7">Termos e Condições</h3>
          <ul>
            <li className="mb-6">
              <h4>1. Termos</h4>
              <p className="ps-6">
                Ao acessar ao site Techfatos, concorda em cumprir estes termos
                de serviço, todas as leis e regulamentos aplicáveis ​​e concorda
                que é responsável pelo cumprimento de todas as leis locais
                aplicáveis. Se você não concordar com algum desses termos, está
                proibido de usar ou acessar este site. Os materiais contidos
            ...
            <li className="mb-6">
              ...
              <p className="ps-6">
                ...
                materiais (informações ou software) no site Techfatos , apenas
              ...
              <ul className="list-decimal ps-16">
                ...
                <li>
                  ...
                  software contido no site Techfatos;{" "}
                </li>
                <li>
              ...
              <p className="ps-6">
                ...
                alguma dessas restrições e poderá ser rescindida por Techfatos a
            ...
            <li className="mb-6">
              ...
              <p className="ps-6">
                Os materiais no site da Techfatos são fornecidos &apos;como
                estão&apos;. Techfatos não oferece garantias, expressas ou
                ...
                direitos. Além disso, o Techfatos não garante ou faz qualquer
            ...
            <li className="mb-6">
              <h4>4. Limitações</h4>
              <p className="ps-6">
                Em nenhum caso o Techfatos ou seus fornecedores serão
                ...
                materiais em Techfatos, mesmo que Techfatos ou um representante
                autorizado da Techfatos tenha sido notificado oralmente ou por
                escrito da possibilidade de tais danos. Como algumas jurisdições
                não permitem limitações em garantias implícitas, ou limitações
                de responsabilidade por danos conseqüentes ou incidentais, essas
            ...
            <li className="mb-6">
              ...
              <p className="ps-6">
                Os materiais exibidos no site da Techfatos podem incluir erros
                técnicos, tipográficos ou fotográficos. Techfatos não garante
                que qualquer material em seu site seja preciso, completo ou
                atual. Techfatos pode fazer alterações nos materiais contidos em
                seu site a qualquer momento, sem aviso prévio. No entanto,
                Techfatos não se compromete a atualizar os materiais.
              </p>
            </li>
            <li className="mb-6">
              <h4>6. Links</h4>
              <p className="ps-6">
                O Techfatos não analisou todos os sites vinculados ao seu site e
                não é responsável pelo conteúdo de nenhum site vinculado. A
                inclusão de qualquer link não implica endosso por Techfatos do
          ...
          <p>
            Modificações <br />
            <br />O Techfatos pode revisar estes termos de serviço do site a
            ...
            <br />
            Lei aplicável <br />
            <br /> Estes termos e condições são regidos e interpretados de
            acordo com as leis do Techfatos e você se submete irrevogavelmente à
